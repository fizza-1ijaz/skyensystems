...
import { MOBILE_APP_PROBLEM_SOLUTION } from "@/lib/mobile-app-service-data";
...
export function MobileAppProblemSolution() {
  return (
          ...
          <Reveal>
            <article className="h-full border border-[#E5E5E3] bg-white p-6 md:p-8">
              <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#8A8A8A]">
                {MOBILE_APP_PROBLEM_SOLUTION.problemHeading}
              </p>
              <PointList points={MOBILE_APP_PROBLEM_SOLUTION.problemPoints} dotClassName="bg-red-500" />
            </article>
          </Reveal>
          ...
          <Reveal delay={0.06}>
            <article className="h-full border border-[#31C3C3]/30 bg-white p-6 md:p-8">
              <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#31C3C3]">
                {MOBILE_APP_PROBLEM_SOLUTION.solutionHeading}
              </p>
              <PointList points={MOBILE_APP_PROBLEM_SOLUTION.solutionPoints} />
            </article>
          </Reveal>
        </div>
        ...
        <Reveal delay={0.1} className="mx-auto mt-10 max-w-4xl">
          <div className="border-l-4 border-[#31C3C3] bg-white px-6 py-5 text-center md:px-8 md:py-6">
            <p className="text-sm leading-relaxed text-[#5C5C5C] md:text-base">
              {MOBILE_APP_PROBLEM_SOLUTION.directAnswer}
            </p>
          </div>
        </Reveal>
      </div>
