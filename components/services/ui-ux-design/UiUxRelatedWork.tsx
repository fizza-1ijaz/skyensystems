...
import { UI_UX_RELATED_WORK } from "@/lib/ui-ux-design-service-data";
...
function RelatedWorkCard({
  ...
  card: (typeof UI_UX_RELATED_WORK.cards)[number];
  index: number;
}) {
  ...
  return (
    ...
    >
      <div className="relative h-16 w-16 overflow-hidden rounded-xl border border-[#E5E5E3] bg-[#FAFAF8]">
        <Image src={card.logo} alt="" fill className="object-contain p-2" sizes="64px" />
      </div>
...
export function UiUxRelatedWork() {
  return (
