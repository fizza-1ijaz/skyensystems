...
import { MOBILE_APP_TECHNOLOGY_STACK } from "@/lib/mobile-app-service-data";
...
export function MobileAppTechnologyStack() {
  const [activeIndex, setActiveIndex] = useState(0);
  const activeStack = MOBILE_APP_TECHNOLOGY_STACK.groups[activeIndex];
      ...
      <div className="mx-auto max-w-[1440px] px-6 md:px-10">
        ...
        <div className="mx-auto mt-14 grid max-w-5xl gap-8 lg:grid-cols-12 lg:gap-12">
          <Reveal className="lg:col-span-4">
            ...
            <ul className="flex flex-col gap-3" role="tablist" aria-label="Mobile app technology stacks">
              {MOBILE_APP_TECHNOLOGY_STACK.groups.map((group, index) => {
                ...
                return (
                  <li key={group.category}>
                    <StackBubbleButton
                      ...
                      tabId={`mobile-app-tech-tab-${index}`}
                      panelId={`mobile-app-tech-panel-${index}`}
                    />
                  </li>
                );
              })}
          ...
          <Reveal delay={0.08} className="lg:col-span-8">
            <AnimatePresence mode="wait">
              <motion.article
                ...
                id={`mobile-app-tech-panel-${activeIndex}`}
                role="tabpanel"
                aria-labelledby={`mobile-app-tech-tab-${activeIndex}`}
              ...
              >
                ...
                <p className="mt-3 text-sm text-[#5C5C5C] md:text-base">
                  Technologies we use for {activeStack.category.toLowerCase()} in mobile app projects.
                </p>
