...
import { AI_SOLUTIONS_TECHNOLOGY_STACK } from "@/lib/ai-solutions-service-data";
...
export function AiSolutionsTechnologyStack() {
  const [activeIndex, setActiveIndex] = useState(0);
  const activeStack = AI_SOLUTIONS_TECHNOLOGY_STACK.groups[activeIndex];
      ...
      <div className="mx-auto max-w-[1440px] px-6 md:px-10">
        ...
        <div className="mx-auto mt-14 grid max-w-5xl gap-8 lg:grid-cols-12 lg:gap-12">
          <Reveal className="lg:col-span-4">
            ...
            <ul className="flex flex-col gap-3" role="tablist" aria-label="AI solutions technology stacks">
              {AI_SOLUTIONS_TECHNOLOGY_STACK.groups.map((group, index) => {
                ...
                return (
                  <li key={group.category}>
                    <StackBubbleButton
                      ...
                      tabId={`ai-solutions-tech-tab-${index}`}
                      panelId={`ai-solutions-tech-panel-${index}`}
                    />
                  </li>
                );
              })}
          ...
          <Reveal delay={0.08} className="lg:col-span-8">
            <AnimatePresence mode="wait">
              <motion.article
                ...
                id={`ai-solutions-tech-panel-${activeIndex}`}
                role="tabpanel"
                aria-labelledby={`ai-solutions-tech-tab-${activeIndex}`}
              ...
              >
                ...
                <p className="mt-3 text-sm text-[#5C5C5C] md:text-base">
                  Technologies we use for {activeStack.category.toLowerCase()} in AI automation projects.
                </p>
