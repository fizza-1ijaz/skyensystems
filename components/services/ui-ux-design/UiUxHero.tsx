        ...
        <div className="lg:col-span-7">
          ...
          <Reveal delay={0.1}>
            <p className="mt-6 max-w-2xl text-sm leading-relaxed text-[#5C5C5C] md:text-base">
              {UI_UX_HERO.paragraph}
            </p>
          </Reveal>
          <Reveal delay={0.14} className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <EditorialBoxCta href={UI_UX_HERO.primaryCta.href} variant="primary">
              {UI_UX_HERO.primaryCta.label}
            </EditorialBoxCta>
            <EditorialBoxCta href={UI_UX_HERO.secondaryCta.href} variant="neutral">
              {UI_UX_HERO.secondaryCta.label}
            </EditorialBoxCta>
          </Reveal>
          <Reveal delay={0.18} className="mt-8">
            <ul className="grid gap-2 sm:grid-cols-2">
              {UI_UX_HERO.trustPoints.map((point) => (
