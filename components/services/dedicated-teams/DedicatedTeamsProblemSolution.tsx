...
export function DedicatedTeamsProblemSolution() {
  return (
    <section className="border-b border-[#E5E5E3] bg-white py-20 md:py-28">
      <div className="mx-auto max-w-[1440px] px-6 md:px-10">
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-2 lg:gap-10">
          <Reveal>
            <article className="h-full border border-[#E5E5E3] bg-[#FAFAF8] p-6 md:p-8">
          ...
          <Reveal delay={0.06}>
            <article className="h-full border border-[#31C3C3]/30 bg-[#FAFAF8] p-6 md:p-8">
              <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#31C3C3]">
                {DEDICATED_TEAMS_PROBLEM_SOLUTION.solutionHeading}
              </p>
              <PointList points={DEDICATED_TEAMS_PROBLEM_SOLUTION.solutionPoints} />
            </article>
          </Reveal>
        </div>

        <Reveal delay={0.1} className="mt-10 max-w-4xl">
          <div className="border-l-4 border-[#31C3C3] bg-[#FAFAF8] px-6 py-5 md:px-8 md:py-6">
            ...
            <p className="mt-3 text-sm leading-relaxed text-[#5C5C5C] md:text-base">
              {DEDICATED_TEAMS_PROBLEM_SOLUTION.directAnswer}
            </p>
          </div>
        </Reveal>
      </div>
