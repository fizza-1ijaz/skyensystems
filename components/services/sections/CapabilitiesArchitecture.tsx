    ...
    <section className="relative overflow-hidden bg-[#141414] py-20 text-[#FAFAF8] md:py-28">
      ...
      <div className="relative mx-auto max-w-[1440px] px-6 md:px-10">
        ...
        <div className="relative mx-auto mt-14 max-w-3xl">
          <div className="absolute left-[1.125rem] top-4 bottom-4 w-px bg-[#6C63FF]/40" aria-hidden />
              ...
              <Reveal key={layer.id} delay={index * 0.06}>
                <li className="relative grid gap-4 py-8 md:grid-cols-12 md:items-start md:py-10">
                  <div className="flex items-start gap-4 md:col-span-4">
                    <span className="relative z-10 flex h-9 w-9 shrink-0 items-center justify-center border border-[#6C63FF] bg-[#141414] text-xs font-bold text-[#6C63FF]">
                  ...
                  {index < CAPABILITY_ARCHITECTURE.length - 1 ? (
                    <div className="absolute -bottom-px left-9 hidden text-[#6C63FF] md:block" aria-hidden>
                      ↓
                    </div>
                  ) : null}
                </li>
