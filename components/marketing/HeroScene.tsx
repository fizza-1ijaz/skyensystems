...
export function HeroScene() {
  ...
  return (
    <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute left-1/2 top-1/2 h-72 w-[70rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-r from-[#31C3C31f] via-[#8B5CF62a] to-[#1E3A8A1c] blur-3xl" />
    </div>
  );
}
