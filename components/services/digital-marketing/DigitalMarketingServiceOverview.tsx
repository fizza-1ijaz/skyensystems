...
import { DIGITAL_MARKETING_SERVICE_OVERVIEW } from "@/lib/digital-marketing-service-data";

export function DigitalMarketingServiceOverview() {
  return (
        ...
        <Reveal delay={0.08} className="mt-10 max-w-4xl">
          <div className="border-l-4 border-[#31C3C3] bg-white px-6 py-5 md:px-8 md:py-6">
            ...
            <p className="mt-3 text-sm leading-relaxed text-[#5C5C5C] md:text-base">
              {DIGITAL_MARKETING_SERVICE_OVERVIEW.directAnswer}
            </p>
          </div>
        </Reveal>
      </div>
