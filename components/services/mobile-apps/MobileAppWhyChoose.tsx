...
import { MOBILE_APP_WHY_CHOOSE } from "@/lib/mobile-app-service-data";
    ...
    <section className="border-b border-[#E5E5E3] bg-[#141414] py-20 text-[#FAFAF8] md:py-28">
      <div className="mx-auto max-w-[1440px] px-6 md:px-10">
        ...
        <Reveal className="mt-12 flex justify-center md:mt-14">
          <EditorialBoxCta href={MOBILE_APP_WHY_CHOOSE.cta.href} variant="primary">
            {MOBILE_APP_WHY_CHOOSE.cta.label}
          </EditorialBoxCta>
        </Reveal>
      </div>
    </section>
